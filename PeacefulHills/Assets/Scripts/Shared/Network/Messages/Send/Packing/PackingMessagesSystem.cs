...
namespace PeacefulHills.Network.Messages
{
    ...
    public class PackingMessagesSystem : SystemBase
    {
        ...
        protected override void OnCreate()
        {
            ...
            _messagesQuery = GetEntityQuery(ComponentType.ReadOnly<WrittenMessage>(),
        ...
        private PopMessagesStage PopMessages(GatherTargetsStage gatherTargetsStage)
        {
            ...
            EntityCommandBuffer.ParallelWriter commandBuffer =
                _endSimulationBuffer.CreateCommandBuffer().AsParallelWriter();
            ...
            {
                Dependency = dependency, Targets = gatherTargetsStage.Targets, JaggedMessages = jaggedMessages
            };
        }
        ...
        private PopMessagesStage SortMessages(PopMessagesStage popMessagesStage)
        {
            ...
            var sortMessagesJob = new SortMessagesJob {JaggedMessages = jaggedMessages};
        ...
        private JobHandle PackMessages(PopMessagesStage popMessagesStage)
        {
            ...
            {
                Targets = targets, TargetsMessages = jaggedMessages, CommandBuffer = commandBuffer
            };
